...
/**
 * /pacientes/[id]/documentos — gestão de documentos de um paciente.
 *
 * Funcionalidades:
 *  - Listagem por categoria (tabs)
 *  - Visualizador in-app de PDF e imagens
 *  - Upload de arquivo (file picker)
 *  - Captura por câmera
 *  - Assinatura digital por toque
 *  - Compartilhamento (WhatsApp, e-mail, link)
 *  - Download + cache offline (IndexedDB)
...
export default function PatientDocumentsPage() {
  ...
  const fetchDocs = useCallback(async (silent = false) => {
    ...
    try {
      ...
      // Verifica quais estão em cache offline
